...
class Coordinators_model extends MY_Model{
  ...
  public function getCoordinators(){
    ...
    $this->db->where( 'u.id_perfil =', $this->config->item('perfil_coordenador') );
   ...
   * @return  array/false
   */
  public function getCoordinator( $intID ){
    $this->db->select( 'u.id' );
    $this->db->select( 'u.status' );
    $this->db->select( 'u.nome' );
    $this->db->select( 'u.email' );
   ...
   * @return  bool
   */
  public function setCoordinator( $arrData ){
