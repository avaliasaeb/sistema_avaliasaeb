    ...
    <div class="card-body p-0">
      <div class="p-5">      
        <div class="text-center">
          ...
          <h1 class="h4 text-gray-900 mb-4"><?= $this->lang->line('page_recover_1') ?></h1>
        </div>
        <form class="user ajax" method="post" action="<?= site_url('public/recover/process') ?>">
          <div class="form-group">
            <p class="text-center"><?= $this->lang->line('page_recover_2') ?></p>
          </div>
          ...
          <div class="form-group">
          	<button type="submit" class="btn btn-lg btn-dark w-100"><?= $this->lang->line('form_recuperar') ?></button>
          </div>
        </form>
        <hr>
        <div class="text-center">
          <a href="<?= site_url('public/login') ?>"><?= $this->lang->line('page_recover_3') ?></a>
          <hr>
