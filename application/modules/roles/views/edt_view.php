...
<div class="container-fluid pb-4">
	...
	<div class="row">
		<div class="col-lg-8">
		  <div class="card">
		  	<div class="card-body">
		    	<form action="<?= site_url('roles/role/update') ?>" method="post" class="ajax">
		  			<input type="hidden" name="input_id" value="<?= $item['id'] ?>">
		      	<div class="row">
		      		<div class="col-lg-6">
				  			<div class="form-floating mb-3">
								  <input type="text" name="input_nome" class="form-control" id="input_nome" value="<?= $item['perfil'] ?>" required autocomplete="off">
			      				...
			      				<div class="permission-list">
								    ...
								    <?php } ?>
											<div class="custom-control custom-switch mb-2">
											  ...
											  <input class="custom-control-input" type="checkbox" name="input_permission[]" role="switch" <?php if( $obj['id'] == '1' ){ echo 'disabled checked'; }else{ if( in_array( $obj['id'], $item['permissoes'] ) ){ echo 'checked'; } } ?> value="<?= $obj['id'] ?>" id="input_permission_<?= $obj['id'] ?>">
