...
class Students_model extends MY_Model{
   ...
   * @return  array/false
   */
  public function getStudent( $intID ){
    $this->db->select( 'u.id' );
    $this->db->select( 'u.status' );
    $this->db->select( 'u.nome' );
    $this->db->select( 'u.email' );
  ...
  public function setStudent( $arrData ){
    ...
    $arrNovo['id_turma'] = $arrData['id_turma'];
  ...
  public function updateStudent( $arrData ){
    ...
    $this->db->set( 'id_turma', $arrData['id_turma'] );    
   ...
   * @return  bool
   */
  public function updateStudentLogin( $arrData ){
    $this->db->set( 'dt_alteracao', $arrData['dt_alteracao'] ); 
