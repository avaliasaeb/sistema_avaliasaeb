			...
			<div class="tab-content" id="myTabContent">
			  <div class="tab-pane card show active" id="meus-dados-tab-pane" role="tabpanel" aria-labelledby="meus-dados-tab" tabindex="0">
			  	<div class="card-body">
			  		...
			  		<form action="<?= site_url('students/student/update') ?>" method="post" class="ajax">
			      		...
			      		<div class="col-lg-6">
					  			<div class="form-floating mb-3">
									  <select name="input_turma" class="form-control" id="input_turma" required autocomplete="off">
									    ...
									    <option <?= $obj['id'] == $item['id_turma'] ? 'selected' : '' ?> value="<?= $obj['id'] ?>"><?= $obj['turma'] ?></option>
									    <?php } } ?>
									  </select>
			  ...
			  <div class="tab-pane card" id="login-senha-tab-pane" role="tabpanel" aria-labelledby="login-senha-tab" tabindex="0">
			  	<div class="card-body">
			  		...
			  		<form class="ajax" action="<?= site_url('students/student/updatelogin') ?>" method="post">
			  			<input type="hidden" name="input_id" value="<?= $item['id'] ?>">
			  			<div class="form-floating mb-3">
