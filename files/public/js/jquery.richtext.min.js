...
(function($) {
    $.fn.richText = function(options) {
        ...
        for (let fontSize = 24; fontSize >= 12; fontSize -= 2) {
            $fontSizes.append($("<li />", {
                html: '<a style="font-size:' + fontSize + 'px;" data-command="fontSize" data-option="' + fontSize + '">' + settings.translations.text + " " + fontSize + "px</a>"
            }))
        }
        ...
        if (settings.imageHTML && ($(settings.imageHTML).find("#imageURL").length > 0 || $(settings.imageHTML).attr("id") === "imageURL")) {
            ...
            $imageForm.append($formItem.clone().append($formLabel.clone().text(settings.translations.altText).attr("for", "altText")).append($formInput.clone().attr("id", "altText")));
